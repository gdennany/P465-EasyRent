                        ...
                        <div class="col-xl-10 col-lg-10">
                            <div class="menu-wrapper  d-flex align-items-center justify-content-end">
                                        ...
                                        <ul id="navigation">                                                                                          
                                            ...
                                            <li><a href="#">Pages</a>
                                                <ul class="submenu">
													...
													<li><a href="yourProfile.html">Profile</a></li>
                                                </ul>
                                            </li>
                                ...
                                <div class="header-right-btn d-none d-lg-block ml-65">
                                    <a href="contact" class="border-btn">Post a Job</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
...
<main>
    ...
    <section class="contact-section">
        <div class="container">
                ...
                <!-- The below implementation was a google map. It was unneccessary here
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Contact EasyRent customer service</h2>
                </div>
                <div class="col-lg-8">
                    <form action="/contact" id="sendContactForm" name="sendContactForm" method="post">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" name="sendMessageButton" id="sendMessageButton" class="button button-contactForm boxed-btn">Send</button>
                        </div>
                    </form>
                </div>

                <input id="successfulContact" name="successfulContact" type="hidden" value=${successfulContact}>
                <div class="modalThird">
                        <div class="modal-contentThird">
                          <span class="close-buttonThird">&times;</span>
                          <c:choose>
                            <c:when test="${successfulContact == '1'}">
                              <h2>Successful submission!</h2>
                              <br/>
                              <h3>We have received your inquiry and will get back to you at the email address you provided soon.</h3>
                            </c:when>
                            <c:when test="${successfulContact == '-1'}">
                              <h2>We are sorry, but something went wrong.</h2>
                              <br/>
                              <h3>We were unable to process your inquiry. Please try again.</h3>
                            </c:when>
                          </c:choose>
                        </div>
                      </div>
                ...
                <div class="col-lg-3 offset-lg-1">
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>easyrentcustomerservice@gmail.com</h3>
