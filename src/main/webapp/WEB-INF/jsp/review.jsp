        ...
        <div class="section-top-border">
          <div class="row">
            <div class="col-lg-8 col-md-8">
              <h3 class="mb-30">Fill Out This Form to Leave a Review...</h3>
              <form name="myform" action="addReview" method="post">
                <p style = "margin-right:10px">Rating(1-5): <input name="rating" style="box-shadow: 0 0 3px #000000;" class="single-input" type="number" min="1" max="5" placeholder="5" /></p>
                  <div class="mt-10">
                  <textarea style="box-shadow: 0 0 3px #000000; margin-top: 20px" class="single-textarea"  name= "review" placeholder="Write a review..." onfocus="this.placeholder = ''"
                            onblur="this.placeholder = 'Write a review...'" required></textarea>
                  </div>


                <input type = "hidden" name = "product" value="${product}">

                <button type="submit" class="genric-btn primary mt-10" >Submit</button>
              </form>
            </div>
          </div>
        </div>
